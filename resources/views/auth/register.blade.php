<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="space-y-1">
            ...
            <h1 class="text-2xl font-black tracking-tight text-darkblue-700">Join Hot Dish</h1>
            <p class="text-sm leading-6 text-slate-600">Create an account to save your preferences and enjoy a smoother checkout flow.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="mt-6 space-y-5">
            ...
            <div>
                ...
                <x-input id="password" class="input-field mt-2" type="password" name="password" required autocomplete="new-password" />
            </div>

            <div>
                <label for="password_confirmation" class="block text-sm font-semibold text-darkblue-700">Confirm Password</label>
                <x-input id="password_confirmation" class="input-field mt-2" type="password" name="password_confirmation" required autocomplete="new-password" />
            </div>
