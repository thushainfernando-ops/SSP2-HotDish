<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="space-y-1">
            ...
            <h1 class="text-2xl font-black tracking-tight text-darkblue-700">Log in to Hot Dish</h1>
            <p class="text-sm leading-6 text-slate-600">Access your saved cart, recent orders, and the polished checkout journey.</p>
        </div>
